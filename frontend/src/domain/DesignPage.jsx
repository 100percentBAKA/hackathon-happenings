  ...
  const handleSubmit = async (event) => {
    ...
    if ([files.length == 3]) {
      const data = await axios.post(
        "https://ada3-103-191-91-22.ngrok-free.app/api/v1/extract",
        {
      ...
      const response = await axios.post(
        "https://ada3-103-191-91-22.ngrok-free.app/api/v1/generate-ad",
        data.data
      );
        ...
        <div className="px-4 py-5 sm:p-6">
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-6">
              {["Brand details", "Guidelines", "Campaign details"].map(
                (value, index) => (
