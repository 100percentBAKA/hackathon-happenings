...
prompt = (
    PromptTemplate.from_template("You are provided with the campaign details which are as follows. Campaign details: {campaign_details}")
    + ", for the brand: {brand}"
...
formatted_prompt = prompt.format(campaign_details=campaign, guidelines=guidelines, brand=brand)
